...
{!! Form::model($pengeluaran,array('url'=>'pengeluaran/'.$pengeluaran->id,'method'=>'get')) !!}
<table class="table table-bordered">
	...
	<tr><td>Anggaran Bibit</td>
		...
		<td>{!! Form::text('real_bibit',null,array('id'=>'bibit','class' => 'form-control','readonly')) !!}</td>
		<td>Keterangan</td>
		<td>{!! Form::text('ket_real_bibit',null,['class'=>'form-control','readonly']) !!}</td>
	</tr>
	...
	<tr><td>Anggaran Nutrisi</td>
		...
		<td>{!! Form::text('real_nutrisi',null,array('id'=>'nutrisi','class' => 'form-control','readonly')) !!}</td>
		<td>Keterangan</td>
		<td>{!! Form::text('ket_real_bibit',null,['class'=>'form-control','readonly']) !!}</td>
	</tr>
	...
	<tr><td>Anggaran Bahan Lain</td>
		...
		<td>{!! Form::text('real_bahan_lain',null,array('id'=>'bahan_lain','class' => 'form-control','readonly')) !!}</td>
		<td>Keterangan</td>
		<td>{!! Form::text('ket_real_bahan_lain',null,['class'=>'form-control','readonly']) !!}</td>
	</tr>
	...
	<tr><td colspan="2">
		{!! link_to(url()->previous(),'Kembali',array('class'=>'btn btn-danger btn-sm','method'=>'get')) !!}
	</td></tr>
</table>
{!! Form::close() !!}
